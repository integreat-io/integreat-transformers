...
test('should transform values to integer', (t) => {
  ...
  t.is(integer(operands)(options)('12345', context), 12345)
  t.is(integer(operands)(options)('12345.345', context), 12345)
  t.is(integer(operands)(options)('12345.30NUM', context), 12345)
  t.is(integer(operands)(options)('-35.1', context), -35)
  t.is(integer(operands)(options)('-35.875', context), -36)
...
test('should transform illegal values to undefined', (t) => {
  ...
  t.is(integer(operands)(options)('NUM12345.30', context), undefined)
